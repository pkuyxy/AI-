...
BAIDU_API_KEY = "rS0Tt3uD3oG5ZlnGjYvRpwK8"  # 替换为你的实际API Key
BAIDU_SECRET_KEY = "Gv3ihY9fo6VOXJcrdm1Ac69Khxk8C9bE"  # 替换为你的实际Secret Key
    ...
    with gr.Blocks(
        ...
        with gr.Row():
            ...
            with gr.Column(scale=8):
                ...
                with gr.Row():  # 使用 gr.Row() 让所有输入组件在同一行
                    # 文本输入框（占主要宽度）
                    msg = gr.Textbox(
                        placeholder="输入消息...",
                        lines=3,
